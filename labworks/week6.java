...
public class Week5a {
    public static void main(String[] args) {
        Client firstClient = new Client("Aibek", "8-(777)-123-12-12", "1");

        System.out.println(firstClient.getName());
        Client.setName(firstClient, "Aibol");
        System.out.println(firstClient.getName());

        System.out.println(firstClient.getPhone());
        Client.setPhone(firstClient, "8-(777)-123-11-11");
        System.out.println(firstClient.getPhone());

        System.out.println(firstClient.getId());

        BankAccount firstBankAccount = new BankAccount("1234 1234 1234 1234", "active", firstClient);
